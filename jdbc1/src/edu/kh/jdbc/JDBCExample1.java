...
public class JDBCExample1 {
	public static void main(String[] arg) {
		...
		/* JDBC (Java DataBase Connextivity)
		 * - Java에서 DB에 접근할 수 있게 해주는
		 *   Java 제공코드 (class, interface)
		 *    -> java.sql 패키지에 존재
		 * 
		 */
		//EMPLOYEE 테이블에서
		...
		try {
			...
			// OracleDriver : Java - Oracle 연결시 필요한 코드가 담긴 클래스-
			...
			/* 5. Statement 객체를 이용해서 SQL 수행 후 결과 받환 받기 */
			...
			// SQLExecption : JDBC 관련 예외의 최상위 부모
			e.printStackTrace();
